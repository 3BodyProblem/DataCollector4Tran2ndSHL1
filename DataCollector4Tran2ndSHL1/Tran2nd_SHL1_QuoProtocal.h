#ifndef __CTP_QUOTATION_PROTOCAL_TRAN2ND_SHL1_H__
#define	__CTP_QUOTATION_PROTOCAL_TRAN2ND_SHL1_H__
#pragma pack(1)
...
typedef struct
{
	...
	unsigned int				IOPV;						///< 基金模拟净值、权证溢价[放大1000倍][ETF、深圳LOF、权证该值有效]
